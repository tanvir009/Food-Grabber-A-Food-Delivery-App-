...
public class CustomerFinalOrders1 {
    ...
    private String Address,Latitude_Lagitude,GrandTotalPrice,MobileNumber,Name,Note,RandomUID,Status;

    public CustomerFinalOrders1(String address, String latitude_Lagitude,String grandTotalPrice, String mobileNumber, String name, String note, String randomUID, String status) {
        Address = address;
