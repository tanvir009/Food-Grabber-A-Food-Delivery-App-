                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        data.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                hashMap1.put("Latitude_Lagitude", customerPaymentOrders1.getLatitude_Lagitude());
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                dataa.addListenerForSingleValueEvent(new ValueEventListener() {
                                                    ...
                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                        ...
                                                        hashMap3.put("Latitude_Lagitude", customerPaymentOrders11.getLatitude_Lagitude());
                                                                                            ...
                                                                                            public void onSuccess(Void aVoid) {
                                                                                                ...
                                                                                                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                                                    ...
                                                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                                                        ...
                                                                                                        dialog.dismiss();
                                                                                                        Intent b = new Intent(CustomerPaymentOTP.this, com.example.foodgrabber.CustomerFoodPanel_BottomNavigation.class);
