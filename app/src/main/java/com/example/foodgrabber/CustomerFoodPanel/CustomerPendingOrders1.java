...
public class CustomerPendingOrders1 {
    ...
    private String Address,Latitude_Lagitude,GrandTotalPrice,MobileNumber,Name,Note;

    public CustomerPendingOrders1(String address, String latitude_Lagitude,String grandTotalPrice, String mobileNumber, String name,String note) {
        Address = address;
