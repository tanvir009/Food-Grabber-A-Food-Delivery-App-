...
public class CustomerPaymentOrders1 {
    ...
    public CustomerPaymentOrders1(String address,String latitude_Lagitude, String grandTotalPrice, String mobileNumber, String name, String note, String randomUID) {
        Address = address;
