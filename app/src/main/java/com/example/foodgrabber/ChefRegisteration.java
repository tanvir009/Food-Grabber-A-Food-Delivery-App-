    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (statee.equals("Khulna")) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(com.example.foodgrabber.ChefRegisteration.this, android.R.layout.simple_spinner_item, list);
        ...
        Cityspin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (cityy.equals("JESSORE")) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(com.example.foodgrabber.ChefRegisteration.this, android.R.layout.simple_spinner_item, listt);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValid()) {
                    ...
                    final ProgressDialog mDialog = new ProgressDialog(com.example.foodgrabber.ChefRegisteration.this);
                                        ...
                                        firebaseDatabase.getInstance().getReference("Chef")
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            AlertDialog.Builder builder = new AlertDialog.Builder(com.example.foodgrabber.ChefRegisteration.this);
                                                            ...
                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent b = new Intent(com.example.foodgrabber.ChefRegisteration.this, ChefVerifyPhone.class);
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodeForAll.ShowAlert(com.example.foodgrabber.ChefRegisteration.this, "Error", task.getException().getMessage());
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(com.example.foodgrabber.ChefRegisteration.this, ChefLogin.class);
                startActivity(i);
                finish();
            }
        });
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent e = new Intent(com.example.foodgrabber.ChefRegisteration.this, Chefloginphone.class);
                startActivity(e);
                finish();
            }
        });
