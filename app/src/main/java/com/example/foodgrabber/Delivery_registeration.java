...
public class Delivery_registeration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ProgressDialog mDialog = new ProgressDialog(com.example.foodgrabber.Delivery_registeration.this);
        ...
        statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (statee.equals("Khulna")) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(com.example.foodgrabber.Delivery_registeration.this, android.R.layout.simple_spinner_item, list);

                    Cityspin.setAdapter(arrayAdapter);
                }
                if (statee.equals("JESSORE")) {
                    ArrayList<String> list = new ArrayList<>();
        ...
        Cityspin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (cityy.equals("JESSORE")) {
                    ...
                    ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(com.example.foodgrabber.Delivery_registeration.this, android.R.layout.simple_spinner_item, listt);
                ...
                if (cityy.equals("CHAPAI NABABGANJ")) {
                    ArrayList<String> listt = new ArrayList<>();
                                        ...
                                        firebaseDatabase.getInstance().getReference("DeliveryPerson").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(hashMappp).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            AlertDialog.Builder builder = new AlertDialog.Builder(com.example.foodgrabber.Delivery_registeration.this);
                                                            ...
                                                            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                ...
                                                                public void onClick(DialogInterface dialog, int which) {
                                                                    ...
                                                                    Intent b = new Intent(com.example.foodgrabber.Delivery_registeration.this, Delivery_VerifyPhone.class);
                                                            ...
                                                            mDialog.dismiss();
                                                            ReusableCodeForAll.ShowAlert(com.example.foodgrabber.Delivery_registeration.this, "Error", task.getException().getMessage());
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent e = new Intent(com.example.foodgrabber.Delivery_registeration.this, com.example.foodgrabber.Delivery_LoginPhone.class);
                startActivity(e);
                finish();
            }
        });
        ...
        Emaill.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(com.example.foodgrabber.Delivery_registeration.this, Delivery_Login.class);
                startActivity(a);
                finish();
            }
        });
