...
public class ChooseOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Chef.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (type.equals("Email")) {
                    Intent loginemail = new Intent(com.example.foodgrabber.ChooseOne.this, ChefLogin.class);
                    startActivity(loginemail);
                    finish();
                }
                if (type.equals("Phone")) {
                    Intent loginphone = new Intent(com.example.foodgrabber.ChooseOne.this, Chefloginphone.class);
                    startActivity(loginphone);
                    finish();
                }
                if (type.equals("SignUp")) {
                    Intent Register = new Intent(com.example.foodgrabber.ChooseOne.this, ChefRegisteration.class);
        ...
        Customer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (type.equals("Email")) {
                    Intent loginemailcust = new Intent(com.example.foodgrabber.ChooseOne.this, Login.class);
                    startActivity(loginemailcust);
                    finish();
                }
                if (type.equals("Phone")) {
                    Intent loginphonecust = new Intent(com.example.foodgrabber.ChooseOne.this, LoginPhone.class);
                    startActivity(loginphonecust);
                    finish();
                }
                if (type.equals("SignUp")) {
                    Intent Registercust = new Intent(com.example.foodgrabber.ChooseOne.this, Registeration.class);
        ...
        DeliveryPerson.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (type.equals("SignUp")) {
                    Intent Registerdelivery = new Intent(com.example.foodgrabber.ChooseOne.this, Delivery_registeration.class);
                    startActivity(Registerdelivery);
                }
                if (type.equals("Phone")) {
                    Intent loginphone = new Intent(com.example.foodgrabber.ChooseOne.this, Delivery_LoginPhone.class);
                    startActivity(loginphone);
                    finish();
                }
                if (type.equals("Email")) {
                    Intent loginemail = new Intent(com.example.foodgrabber.ChooseOne.this, Delivery_Login.class);
                    startActivity(loginemail);
                    finish();
                }
            }
