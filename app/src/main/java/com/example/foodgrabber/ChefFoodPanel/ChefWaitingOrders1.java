...
public class ChefWaitingOrders1 {
    ...
    public ChefWaitingOrders1(String address, String latitude_Lagitude,String grandTotalPrice, String mobileNumber, String name, String note, String randomUID, String status) {
        Address = address;
