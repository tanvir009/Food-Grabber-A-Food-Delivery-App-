...
import com.example.foodgrabber.Chef;
...
public class Chef_PostDish extends AppCompatActivity {
    ...
    private boolean isValid() {
        ...
        boolean isValidDishName = false, isValiDescription = false, isValidPrice = false, isvalidQuantity = false, isvalid = false;
        if (TextUtils.isEmpty(dishes)) {
            Dishes.setErrorEnabled(true);
            Dishes.setError("Dish Name is Required");

        } else {

            Dishes.setError(null);
        ...
        isvalid = (isValidDishName && isValiDescription && isvalidQuantity && isValidPrice) ? true : false;
