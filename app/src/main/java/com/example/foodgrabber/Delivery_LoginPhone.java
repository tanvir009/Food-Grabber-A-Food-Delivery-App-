    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendotp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent b = new Intent(com.example.foodgrabber.Delivery_LoginPhone.this, Delivery_SendOtp.class);
        ...
        txtsignup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent a = new Intent(com.example.foodgrabber.Delivery_LoginPhone.this, Delivery_registeration.class);
                startActivity(a);
                finish();
            }
        });
        ...
        signinemail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent em = new Intent(com.example.foodgrabber.Delivery_LoginPhone.this, Delivery_Login.class);
                startActivity(em);
                finish();
            }
        });
