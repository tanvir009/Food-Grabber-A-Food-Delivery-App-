...
public class Registeration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            mDialog = new ProgressDialog(com.example.foodgrabber.Registeration.this);
            ...
            statespin.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (statee.equals("Khulna")) {
                        ...
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(com.example.foodgrabber.Registeration.this, android.R.layout.simple_spinner_item, list);
            ...
            City.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (cityy.equals("JESSORE")) {
                        ...
                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(com.example.foodgrabber.Registeration.this, android.R.layout.simple_spinner_item, listt);
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    FAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            if (task.isSuccessful()) {
                                                                mDialog.dismiss();
                                                                AlertDialog.Builder builder = new AlertDialog.Builder(com.example.foodgrabber.Registeration.this);
                                                                ...
                                                                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                                                    ...
                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                        ...
                                                                        Intent b = new Intent(com.example.foodgrabber.Registeration.this, VerifyPhone.class);
                                                                ...
                                                                mDialog.dismiss();
                                                                ReusableCodeForAll.ShowAlert(com.example.foodgrabber.Registeration.this,"Error",task.getException().getMessage());
        ...
        Email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(com.example.foodgrabber.Registeration.this, com.example.foodgrabber.Login.class);
                startActivity(i);
                finish();
            }
        });
        ...
        Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent e = new Intent(com.example.foodgrabber.Registeration.this, com.example.foodgrabber.LoginPhone.class);
                startActivity(e);
                finish();
            }
        });
