    ...
    private void Shipped() {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Latitude_Lagitude = deliveryShipFinalOrders1.getLatitude_Lagitude();

                Navigate.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(Intent.ACTION_VIEW,
                                Uri.parse("http://maps.google.com/maps?&daddr="+Latitude_Lagitude));
                        //24.592583625330544, 88.27044148771849 bhaten kha mor
                        //24.37451567821358, 88.60416425090447 rajshahi
